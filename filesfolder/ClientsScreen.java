...
public class ClientsScreen extends JPanel {
    ...
    private void deleteSelectedClient() {
        ...
        // Check if client has loans and user is not admin
        if (client.getLoanCount() > 0 && !"admin".equalsIgnoreCase(currentUserRole)) {
            JOptionPane.showMessageDialog(this,
                "Cannot delete client with active loans. Only administrators can delete clients with loans.",
